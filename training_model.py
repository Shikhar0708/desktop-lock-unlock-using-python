...
faces,ids = getImagesAndLabels('path to the dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists('path to where you want to save the model')    # Save the model into trainer.yml
