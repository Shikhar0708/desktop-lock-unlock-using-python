...
assure_path_exists("path to the folder") # add path to the folder where all the files are saved

recognizer.read('path to the model')  #load training model
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if(confidence>80):                 #confidence usually comes greater than 80 for strangers
            ...
            Id = "Shikhar + {0:.2f}%".format(round(100 - confidence, 2)) 
            print("Verified")
            print(confidence)
            counter_correct += 1
